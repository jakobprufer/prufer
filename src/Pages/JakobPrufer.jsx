          ...
          <div>
            ...
            <div className="albumPlayers">
              ...
              <div className="albumPlayer">
                ...
                <Player
                  source={"/Assets/jakobprufer/audio/Supasilva/WoahMaster.mp3"}
                  showMute={false}
                  currentPlaying={currentPlaying}
                  setCurrentPlaying={setCurrentPlaying}
                  id={"2"}
              ...
              <div className="albumPlayer">
                <div className="playerTitle">
                  Jakob Prufer & Nick01 - Geht Nicht (prod. pizzle & LowPass)
                </div>
                <Player
                  source={
              ...
              <div className="albumPlayer">
                <div className="playerTitle">
                  Jakob Prufer & LowPass & Nick01 - Richmond Freestlye (prod.
                  LowPass)
                </div>
                <Player
                  source={
